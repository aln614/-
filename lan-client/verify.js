...
assert(fs.readFileSync(path.join(root, 'package.json'), 'utf8').includes('"electronVersion": "35.7.5"'), 'LAN client build must pin its Electron version');
...
console.log('[lan-client:check] OK: dedicated LAN client defaults to http://192.168.110.30:7868.');
