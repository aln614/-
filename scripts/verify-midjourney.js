...
if (!indexHtml.includes('/static/app.js?v=1.0.42') || !indexHtml.includes('/static/style.css?v=1.0.42')) fail('Renderer assets do not carry the current release cache key');
