...
if (!indexHtml.includes('/static/app.js?v=1.0.43') || !indexHtml.includes('/static/style.css?v=1.0.43')) fail('Renderer assets do not carry the current release cache key');
