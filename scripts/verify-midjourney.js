...
if (!indexHtml.includes('/static/app.js?v=1.0.68') || !indexHtml.includes('/static/style.css?v=1.0.68')) fail('Renderer assets do not carry the current release cache key');
