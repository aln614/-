...
function pickApimartVideoUrls(status={}) {
  ...
  const looksVideo = (s, ctx='') => {
    ...
    if (/\.(png|jpe?g|webp|gif|bmp|avif|svg)(\?|#|$)/i.test(x)) return false;
    if (/image|thumbnail|thumb|cover|poster|frame/i.test(c)) return false;
    if (/\.(mp4|mov|webm|m4v|avi)(\?|#|$)/i.test(x)) return true;
    if (/video/i.test(c)) return true;
...
registerApimartVideoRules([
  ...
  { model:'doubao-seedance-1-0-pro-fast', apiModel:'seedance-1-0-pro-fast', label:'Seedance 1.0 Pro Fast', resolutions:['480p','720p','1080p'], defaultResolution:'1080p', aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9'], durationRange:[2,12], defaultDuration:5, supportsImageUrls:false, supportsImageWithRoles:true, supportsLastFrame:false, maxImageCount:1 },
  { model:'doubao-seedance-1-0-pro-quality', apiModel:'seedance-1-0-pro-quality', label:'Seedance 1.0 Pro Quality', resolutions:['480p','720p','1080p'], defaultResolution:'1080p', aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9'], durationRange:[2,12], defaultDuration:5, supportsImageUrls:false, supportsImageWithRoles:true, supportsLastFrame:true, maxImageCount:2 },
  { model:'doubao-seedance-1-5-pro', apiModel:'seedance-1-5-pro', label:'Seedance 1.5 Pro', resolutions:['480p','720p','1080p'], defaultResolution:'720p', aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9'], durationRange:[4,12], supportsImageUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, maxImageCount:2, audioParam:'audio', defaultAudio:true, cameraFixedParam:'camerafixed' },
  { model:'doubao-seedance-2.0', apiModel:'seedance-2.0', label:'Seedance 2.0', resolutions:['480p','720p','1080p','4k'], aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9','adaptive'], aspectParam:'size', durationRange:[4,15], supportsImageUrls:true, supportsVideoUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, maxImageCount:9, maxVideoCount:3, referenceVideoTotalDurationMin:1.8, referenceVideoTotalDurationMax:15.2, videoParam:'video_urls', durationWithVideo:true, disallowFrameReferenceMix:true, audioParam:'generate_audio', defaultAudio:true, returnLastFrameParam:'return_last_frame', audioReferenceParam:'audio_urls', maxAudioCount:3, audioRequiresReference:true, audioMaxDuration:15, audioTotalDuration:15, audioReferenceMaxBytes:15*1024*1024, promptOptionalWithMedia:true },
  { model:'doubao-seedance-2.0-fast', apiModel:'seedance-2.0-fast', label:'Seedance 2.0 Fast', resolutions:['480p','720p'], aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9','adaptive'], aspectParam:'size', durationRange:[4,15], supportsImageUrls:true, supportsVideoUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, maxImageCount:9, maxVideoCount:3, referenceVideoTotalDurationMin:1.8, referenceVideoTotalDurationMax:15.2, videoParam:'video_urls', durationWithVideo:true, disallowFrameReferenceMix:true, audioParam:'generate_audio', defaultAudio:true, returnLastFrameParam:'return_last_frame', audioReferenceParam:'audio_urls', maxAudioCount:3, audioRequiresReference:true, audioMaxDuration:15, audioTotalDuration:15, audioReferenceMaxBytes:15*1024*1024, promptOptionalWithMedia:true },
  { model:'doubao-seedance-2.0-mini', apiModel:'seedance-2.0-mini', label:'Seedance 2.0 Mini', resolutions:['480p','720p'], aspectRatios:['16:9','9:16','1:1','4:3','3:4','21:9','adaptive'], aspectParam:'size', durationRange:[4,15], supportsImageUrls:true, supportsVideoUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, maxImageCount:9, maxVideoCount:3, referenceVideoTotalDurationMin:1.8, referenceVideoTotalDurationMax:15.2, videoParam:'video_urls', durationWithVideo:true, disallowFrameReferenceMix:true, audioParam:'generate_audio', defaultAudio:true, returnLastFrameParam:'return_last_frame', audioReferenceParam:'audio_urls', maxAudioCount:3, audioRequiresReference:true, audioMaxDuration:15, audioTotalDuration:15, audioReferenceMaxBytes:15*1024*1024, promptOptionalWithMedia:true },
  { model:'doubao-seedance-2.5', apiModel:'seedance-2.5', label:'Seedance 2.5', resolutions:['480p','720p','1080p'], defaultResolution:'720p', aspectRatios:['16:9','4:3','1:1','3:4','9:16','21:9','adaptive'], defaultAspectRatio:'adaptive', aspectParam:'size', durationRange:[4,30], defaultDuration:5, supportsAutoDuration:true, supportsImageUrls:true, supportsVideoUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, imageRolesBecomeReferencesWithMedia:true, maxImageCount:30, maxVideoCount:10, referenceVideoDurationRange:[2,30], referenceVideoTotalDurationMax:30, videoParam:'video_urls', durationWithVideo:true, audioParam:'generate_audio', defaultAudio:true, watermarkParam:'watermark', returnLastFrameParam:'return_last_frame', audioReferenceParam:'audio_urls', maxAudioCount:10, audioMinDuration:2, audioMaxDuration:30, audioTotalDuration:30, audioReferenceMaxBytes:15*1024*1024, outputFormatParam:'output_format', outputFormats:['mp4','mov'], forceAdaptiveForVideoEdit:true, forceAdaptiveForFrameModes:true, forceAutoDurationForVideoEdit:true },
  ...
  { model:'wan3.0-video', label:'Wan3.0 Video', resolutions:['480P','720P','1080P'], defaultResolution:'1080P', aspectRatios:['adaptive','16:9','4:3','1:1','3:4','9:16'], defaultAspectRatio:'adaptive', aspectParam:'size', durationRange:[2,30], defaultDuration:5, supportsAutoDuration:true, supportsImageUrls:true, supportsVideoUrls:true, supportsImageWithRoles:true, supportsLastFrame:true, imageRolesBecomeReferencesWithMedia:true, referenceFamilyInputsForceReferenceImages:true, generationTypeParam:'generation_type', maxImageCount:10, videoParam:'video_urls', maxVideoCount:5, referenceVideoDurationRange:[1,15], referenceVideoTotalDurationMax:15, referenceVideoDurationPlusOutputMax:30, durationWithVideo:true, audioParam:'audio', defaultAudio:true, audioReferenceParam:'audio_urls', maxAudioCount:5, audioMinDuration:1, audioMaxDuration:15, audioTotalDuration:15, audioReferenceMaxBytes:15*1024*1024, watermarkParam:'watermark', promptOptionalWithMedia:true, supportsDocumentReference:true, supportsLinkReference:true },
  ...
  { model:'wan2.6-i2v', label:'Wan2.6 I2V', resolutions:['720p','1080p'], defaultResolution:'1080p', aspectParam:false, durationRange:[2,15], defaultDuration:5, supportsImageUrls:true, minImageCount:1, maxImageCount:1, watermarkParam:'watermark', negativePromptParam:'negative_prompt', promptOptionalWithMedia:true },
  { model:'wan2.6-i2v-flash', label:'Wan2.6 I2V Flash', resolutions:['720p','1080p'], defaultResolution:'1080p', aspectParam:false, durationRange:[2,15], defaultDuration:5, supportsImageUrls:true, minImageCount:1, maxImageCount:1, audioParam:'audio', defaultAudio:true, watermarkParam:'watermark', negativePromptParam:'negative_prompt', audioReferenceParam:'audio_url', maxAudioCount:1, audioMinDuration:3, audioMaxDuration:30, audioReferenceMaxBytes:15*1024*1024, promptOptionalWithMedia:true },
  ...
  { model:'grok-imagine-1.5-video-apimart', apiModel:'grok-imagine-1.5-video-ext', label:'Grok Imagine 1.5 Video', resolutions:['480p','720p'], defaultResolution:'480p', resolutionParam:'resolution', aspectRatios:['16:9','9:16','1:1','3:2','2:3'], aspectParam:'size', durationRange:[6,15], defaultDuration:6, supportsImageUrls:true, maxImageCount:7, omitAspectWithImages:true },
...
const APIMART_VIDEO_MODEL_ALIASES = Object.freeze({
  ...
  'seedance-1-0-pro-quality': 'doubao-seedance-1-0-pro-quality',
...
async function createApimartVideoTask(body, ownerId, req, cfg, existingRow = null) {
  ...
  const documentItem = body.document_file || null;
  ...
  const documentUrlInput = String(body.file_url || '').trim();
  const linkUrlInput = String(body.link_url || '').trim();
  ...
  try {
    ...
    const generatedLocalDocumentPath = documentItem ? dataUrlToFile(documentItem, ownerId) : '';
    const localDocumentPath = generatedLocalDocumentPath || String(body.local_document_path || row.local_document_path || '').trim();
    let documentFileUrl = documentUrlInput;
    let linkUrl = linkUrlInput;
    if ((localDocumentPath || documentFileUrl) && !rule.supportsDocumentReference) throw new Error(`${rule.label || videoModel} 不支持文档参考。`);
    if (linkUrl && !rule.supportsLinkReference) throw new Error(`${rule.label || videoModel} 不支持网页参考。`);
    if ((localDocumentPath || documentFileUrl) && linkUrl) throw new Error('Wan3.0 文档参考和网页参考不能同时使用。');
    if (localDocumentPath) {
      assertApimartVideoDocumentReferenceFile(localDocumentPath, rule);
      documentFileUrl = await buildPublicTempFileUrlAuto(localDocumentPath, cfg, ownerId, req);
    }
    if (documentFileUrl) documentFileUrl = assertApimartPublicReferenceUrl(documentFileUrl, '文档参考 URL');
    if (linkUrl) linkUrl = assertApimartPublicReferenceUrl(linkUrl, '网页参考 URL');
    ...
    if (rule.referenceFamilyInputsForceReferenceImages && hasReferenceFamilyInputs && imageUrls.length && ['first_frame', 'first_last_frame'].includes(mode)) {
      if (normalizeVideoMode(body.video_mode) !== 'auto') {
        throw new Error(`${rule.label || videoModel} 的首帧 / 首尾帧控制不能与视频、音频、文档或网页参考混用，请使用多素材生成。`);
      }
    ...
    if (rule.disallowFrameReferenceMix && mode === 'first_frame' && imageUrls.length !== 1) {
      throw new Error(`${rule.label || videoModel} 首帧生成需要恰好 1 张参考图。`);
    }
    if (rule.disallowFrameReferenceMix && mode === 'first_last_frame' && imageUrls.length !== 2) {
      throw new Error(`${rule.label || videoModel} 首尾帧生成需要恰好 2 张参考图。`);
    }
    ...
    if (imageUrls.length) {
      ...
      } else if (rule.imageParam === 'first_frame_image' && (mode === 'first_frame' || (mode === 'first_last_frame' && rule.supportsLastFrame))) {
        payload.first_frame_image = imageUrls[0];
      ...
      } else if (rule.supportsImageWithRoles && !(rule.imageRolesBecomeReferencesWithMedia && hasReferenceFamilyInputs) && (mode === 'first_frame' || mode === 'first_last_frame' || !rule.supportsImageUrls)) {
    ...
    row.file_url = documentFileUrl;
    row.link_url = linkUrl;
    row.local_document_path = localDocumentPath;
...
function assertApimartVideoOutputDurationRules({ rule = {}, requestedDuration = 0, sourceDurations = [] } = {}) {
  ...
  if (rule.outputDurationAtMostReferenceVideo) {
  ...
  const totalLimit = Number(rule.referenceVideoDurationPlusOutputMax || 0);
  if (totalLimit > 0 && knownSourceDurations.reduce((sum, value) => sum + value, 0) + outputDuration > totalLimit) {
    throw new Error(`${rule.label || rule.model} 的参考视频总时长与输出时长之和不能超过 ${totalLimit} 秒。`);
  }
}
...
function mapPayloadToQueue(body, owner) {
  ...
  const payload = {
    ...
    negativePrompt: body.negative_prompt || cfg.negativePrompt || cfg.negative_prompt || '',
    promptExtend: body.prompt_extend ?? cfg.promptExtend ?? cfg.prompt_extend ?? false,
    promptExtendMode: body.prompt_extend_mode || cfg.promptExtendMode || cfg.prompt_extend_mode || 'direct',
...
const APIMART_VIDEO_DOCUMENT_EXTENSIONS = new Set([
  '.docx', '.doc', '.xlsx', '.xls', '.pptx', '.ppt', '.pdf', '.txt',
  '.key', '.pages', '.numbers', '.md'
]);

function assertApimartVideoDocumentReferenceFile(filePath, rule = {}) {
  if (!rule.supportsDocumentReference) throw new Error(`${rule.label || rule.model || '当前模型'} 不支持文档参考。`);
  if (!filePath || !fs.existsSync(filePath)) throw new Error('文档参考文件不存在或无法读取。');
  const ext = path.extname(String(filePath)).toLowerCase();
  if (!APIMART_VIDEO_DOCUMENT_EXTENSIONS.has(ext)) {
    throw new Error('Wan3.0 文档参考仅支持 DOC/DOCX、XLS/XLSX、PPT/PPTX、PDF、TXT、KEY、PAGES、NUMBERS 或 MD。');
  }
  const stat = fs.statSync(filePath);
  if (stat.size <= 0) throw new Error('文档参考文件为空。');
  if (stat.size > 100 * 1024 * 1024) throw new Error('Wan3.0 文档参考不能超过 100MB。');
}

function assertApimartPublicReferenceUrl(value, label = '参考链接') {
  const urlValue = String(value || '').trim();
  if (!/^https?:\/\//i.test(urlValue)) throw new Error(`${label}必须是 HTTP/HTTPS 公网地址。`);
  if (/^https?:\/\/(localhost|127\.0\.0\.1|0\.0\.0\.0|192\.168\.|10\.|172\.(1[6-9]|2\d|3[0-1])\.)/i.test(urlValue)) {
    throw new Error(`${label}不能使用本机或局域网地址，APIMart 云端无法访问。`);
  }
  return urlValue;
}
...
async function saveMidjourneyTaskImages(task, ret={}) {
  ...
  if (!rawUrls.length && allResultUrls.length) {
    ...
    rawUrls = allResultUrls.filter(u => !reportedGridKey || normalizeMjRemoteUrl(u) !== reportedGridKey);
  }
  ...
  for (const row of removedGridRows) {
    for (const filePath of [row.file_path, row.thumb_path]) {
      try {
        if (filePath && fs.existsSync(filePath) && !st.images.some(img => img.file_path === filePath || img.thumb_path === filePath)) fs.unlinkSync(filePath);
      } catch {}
    }
  }
...
async function repairCompletedMidjourneyImages(ownerId='') {
  ...
  for (const task of tasks) {
    ...
    if (batch && falseVideoRows.length) {
      const prefix = String(task.task_index || 1).padStart(5, '0');
      for (const row of falseVideoRows) {
        const sourcePath = String(row.file_path || '').trim();
        if (!sourcePath || !fs.existsSync(sourcePath)) continue;
        let header = Buffer.alloc(0);
        try { const fd=fs.openSync(sourcePath,'r'); header=Buffer.alloc(16); fs.readSync(fd,header,0,16,0); fs.closeSync(fd); } catch {}
        const isImagePayload = header.subarray(0,8).equals(Buffer.from([0x89,0x50,0x4e,0x47,0x0d,0x0a,0x1a,0x0a])) || header.subarray(0,3).equals(Buffer.from([0xff,0xd8,0xff])) || header.subarray(0,4).toString('ascii') === 'RIFF' || header.subarray(0,6).toString('ascii').startsWith('GIF8');
        if (!isImagePayload) continue;
        const normalizedRemote = normalizeMjRemoteUrl(row.remote_url || '');
        const variantIndex = urls.findIndex(u => normalizeMjRemoteUrl(u) === normalizedRemote);
        const suffix = normalizeMjRemoteUrl(grid) === normalizedRemote ? '_grid' : `_${Math.max(1, variantIndex + 1)}`;
        let ext = '.png'; try { const match=String(new URL(row.remote_url).pathname||'').match(/\.(png|jpe?g|webp|gif)$/i); if(match) ext=match[0].toLowerCase(); } catch {}
        const recoveredPath = path.join(batch.output_dir, `${prefix}${suffix}${ext}`);
        try { if (!fs.existsSync(recoveredPath)) fs.copyFileSync(sourcePath, recoveredPath); } catch {}
      }
    }
    const existing = st.images.filter(i => i.task_id === task.id);
    ...
    if (falseVideoRows.length) {
      const falseVideoIds = new Set(falseVideoRows.map(v => v.id));
      st.video_tasks = (st.video_tasks || []).filter(v => !falseVideoIds.has(v.id));
      for (const row of falseVideoRows) {
        const badPath = String(row.file_path || '').trim();
        try { if (badPath && fs.existsSync(badPath)) fs.unlinkSync(badPath); } catch {}
      }
      task.mj_video_urls_json = '[]';
      changed = true;
    }
  }
  if (changed) getDB()._save();
...
async function syncMidjourneyTaskState(task, ret={}) {
  ...
  const isVideoAction = String(task.mj_action || '').toLowerCase() === 'video';
  ...
  else if(isSuccess && hasVideoUrls && (isVideoAction || !hasImageUrls)){ await saveMidjourneyTaskVideos(task, ret); if(task.status!=='已完成'){ batch.success_count=Number(batch.success_count||0)+1; batch.running_count=Math.max(0,Number(batch.running_count||0)-1); } task.status='已完成'; task.finished_at=nowISO(); task.progress=100; task.progress_text='Midjourney 视频已完成'; }
